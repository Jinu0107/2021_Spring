<%@page import="com.mycompany.myhome.common.StringUtil"%>
		...
		<form name="form">
			...
			<table class="table">
				...
				<tbody>
					<tr>
						<td>제목</td>
						<td><c:out value="${ freeboardView.title}"></c:out></td>
					</tr>
					<tr>
						<td>작성자</td>
						<td><c:out value="${ freeboardView.writer}"></c:out></td>

					</tr>
					<tr>
						<td>내용</td>
						<td><c:out value="${ freeboardView.contents}"></c:out></td>
